...
class DatabaseMigrations:
    ...
    def apply_indexes(self):
        ...
        try:
            ...
            for statement in indexes_customers + indexes_orders:
                ...
                index_name = statement.split()[
                    2
                ]  # Gets the index name from CREATE INDEX statement
    ...
    def optimize_tables(self):
        ...
        try:
            ...
            optimization_queries = ["OPTIMIZE TABLE customers", "OPTIMIZE TABLE orders"]
            ...
            for query in optimization_queries:
                try:
                    ...
                    logger.warning(
                        f"Could not optimize table with query '{query}': {str(e)}"
                    )
