...
def run_pandas_approach():
    ...
    try:
        ...
        save_results_to_file(
            "pandas_repeat_customers.csv", repeat_customers, format="csv"
        )
        ...
        save_results_to_file(
            "pandas_regional_revenue.csv", regional_revenue, format="csv"
        )
...
def run_dask_approach():
    ...
    try:
        ...
        save_results_to_file(
            "dask_repeat_customers.csv", repeat_customers, format="csv"
        )
        ...
        save_results_to_file(
            "dask_regional_revenue.csv", regional_revenue, format="csv"
        )
        ...
        logger.error(
            "Dask is not installed or not available. Please install it with: pip install dask[dataframe]"
        )
        raise
    except Exception as e:
