...
class Logger:
    ...
    @classmethod
    def log_ingestion_lineage(cls, logger: logging.Logger, file_name: str, load_time: str, 
                             record_count: int, validation_status: str, checksum: str):
        """
        ...
        """
        log_message = (f"INGESTION LINEAGE - File: {file_name}, "
